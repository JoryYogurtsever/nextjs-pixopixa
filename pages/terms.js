...
const AboutPage = () => (
  <>
    ...
    <div>
      ...
      <p>Welcome to PixoPixa.com!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of PixoPixa's Website, located at https://www.pixopixa.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use PixoPixa.com if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing PixoPixa.com, you agreed to
        use cookies in agreement with the PixoPixa's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, PixoPixa and/or its licensors own the
        intellectual property rights for all material on PixoPixa.com. All
        intellectual property rights are reserved. You may access this from
        PixoPixa.com for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from PixoPixa.com</li>
        <li>Sell, rent or sub-license material from PixoPixa.com</li>
        <li>Reproduce, duplicate or copy material from PixoPixa.com</li>
        <li>Redistribute content from PixoPixa.com</li>
      </ul>
      ...
      <p>
        ...
        PixoPixa does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of PixoPixa,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, PixoPixa shall not be liable
      ...
      <p>
        PixoPixa reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant PixoPixa a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of PixoPixa; and (d) the link is
      ...
      <p>
        ...
        e-mail to PixoPixa. Please include your name, your organization name,
      ...
      <p>
        No use of PixoPixa's logo or other artwork will be allowed for linking
